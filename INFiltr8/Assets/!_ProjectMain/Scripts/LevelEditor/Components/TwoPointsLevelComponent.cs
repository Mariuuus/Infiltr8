...
namespace __ProjectMain.Scripts.LevelEditor.Components
{
    ...
    public class TwoPointsLevelComponent : TwoPointsBaseComponent
    {
        ...
        {
            if(LevelEditorUtils.IsPositionBlocked(LevelEditorFileManager.Instance.levelData.components, startPosition, endPosition)) throw new InvalidLevelEditorActionException("There is another component in the way. Please reconsider your placement!");
        }
