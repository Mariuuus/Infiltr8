...
namespace __ProjectMain.Scripts.LevelEditor.Components
{
    ...
    public class TwoPointsBaseComponent : LevelComponent
    {
        ...
        public TwoPointsBaseComponent(Vector2Int startPosition, Vector2Int endPosition, LevelData levelData) 
        {
            ...
            if(!LevelEditorUtils.IsPositionInField(LevelEditorFileManager.Instance.levelData, startPosition)) throw new InvalidLevelEditorActionException("Component is outside of the Level!");
            if(!LevelEditorUtils.IsPositionInField(LevelEditorFileManager.Instance.levelData, endPosition)) throw new InvalidLevelEditorActionException("Component is outside of the Level!");
        }
